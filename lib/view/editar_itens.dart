...
class TelaEditarItensView extends StatefulWidget {
  const TelaEditarItensView({Key? key}) : super(key: key);

  @override
  State<TelaEditarItensView> createState() => _TelaEditarItensViewState();
}

class _TelaEditarItensViewState extends State<TelaEditarItensView> {
  List<Item> itens = [];
